...
assert.equal(formatCountdown(new Date(now + 90_000).toISOString(), now), 'Starts in 1m 30s')
assert.equal(formatCountdown(new Date(now + 3_600_000).toISOString(), now), 'Starts in 1h 0m 0s')
