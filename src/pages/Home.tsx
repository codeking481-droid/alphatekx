...
import { ArrowLeft, ArrowRight, Link2, Store, Wand2 } from 'lucide-react'
        ...
        <div className="w-full">
          <div className="mx-auto w-full max-w-[1500px]">
            <button
              ...
              className="mb-4 inline-flex items-center gap-2 rounded-full border border-violet-300/20 bg-white/5 px-4 py-2 text-sm font-semibold text-violet-100 transition hover:bg-white/10"
            >
              <ArrowLeft size={16} />
              Back to dashboard
            </button>
              ...
              {cards.map((card) => {
                ...
                return (
                  <button
                    key={card.id}
                    type="button"
                    onClick={() => card.id === 'scan' ? setShowScan(true) : navigate(card.route)}
