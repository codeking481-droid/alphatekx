...
export default function Auth() {
  ...
  useEffect(() => {
    ...
    let active = true
    setPending(true)
    setNotice('Completing your secure Google sign-inΓÇª')
      ...
      <div className="relative w-full max-w-2xl overflow-hidden p-4 sm:p-7 lg:p-8">
        <div className="rounded-[1.5rem] border border-white/8 bg-[#0D1020]/75 p-4 shadow-[inset_0_1px_0_rgba(255,255,255,.04)] sm:p-6">
          ...
          <div className="mt-6 space-y-3 text-center">
            <h1 className="text-3xl font-black tracking-[-.05em] text-white sm:text-4xl">Sign up</h1>
          ...
          <div className="mt-7 space-y-4">
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center">
                <span className="bg-[#0D1020] px-4 text-xs font-bold text-slate-400">or use email</span>
              </div>
            </div>
