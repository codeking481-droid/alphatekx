...
function Pricing() {
  ...
  return <section id="pricing" className="bg-white px-4 py-24 sm:px-6 lg:py-32"><div className="mx-auto max-w-7xl"><SectionHeading eyebrow="Simple pricing" title="Start small. Scale to millions." copy="Planning is free. Pay only when Alpha works."/>
    ...
    <div className="mx-auto mt-8 flex max-w-3xl flex-wrap justify-center gap-2 rounded-full border border-[#EAECF0] bg-[#F9FAFB] px-5 py-3 text-center text-xs font-bold text-[#475467]"><span>Google signup = 1 tester credit</span><span className="text-[#D0D5DD]">•</span><span>Human verification = up to 10 credits, one time</span></div>
  </div></section>
}
