...
const RestoreEngine = lazy(() => import('./pages/RestoreEngine'))
...
export default function App() {
  return (
    <AuthProvider>
      ...
      <Route path="/restore-engine" element={protectedPage(<RestoreEngine />)} />
      ...
      <Route path="/deploy" element={protectedPage(<Launch />)} />
