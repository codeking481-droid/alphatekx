      ...
      <div className="w-full max-w-md rounded-2xl border border-violet-400/20 bg-[#1A1A1A] p-6 shadow-2xl">
        ...
        <div className="space-y-3">
          ...
          >
            ...
            <p className="text-xs text-white/60">3 credits + 10 videos/month (max 5 mins)</p>
          </button>
          ...
          >
            ...
            <div className="flex items-center justify-between mb-1">
              <span className="font-semibold text-white">Creator Plan</span>
              <span className="text-lg font-bold text-[#FFD700]">$49</span>
            </div>
            <p className="text-xs text-white/60">15 credits + 30 videos/month (max 8 mins)</p>
          </button>
          ...
          >
            ...
            <p className="text-xs text-white/60">50 credits + unlimited videos (max 12 mins)</p>
          </button>
        </div>
