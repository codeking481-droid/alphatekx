...
export default function ActivityFeedPanel({ activities, building }: { activities: Activity[]; building: boolean }) {
  return <div className="max-h-64 overflow-y-auto px-5 pb-5">
    ...
    {building && <div className="mt-4 flex items-center gap-2 text-xs text-white/55"><Circle className="animate-pulse fill-[#E56B2D] text-white" size={8}/>AI team building your app</div>}
  </div>
}
