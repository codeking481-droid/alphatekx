import{ac as m,r as l,j as t,L as u}from"./vendor-D9u-c24A.js";import{g as f}from"./apiClient-Dn8VGwuS.js";import"./index-B0n72jJy.js";function h(n){var a;let e=String(n||"");const s=[],o=/\bimport\s+(?:type\s+)?([\s\S]*?)\s+from\s+(['"])([^'"]+)\2\s*;?/g;for(const i of e.matchAll(o)){if(i[3]!=="lucide-react")continue;const r=((a=i[1].match(/\{([\s\S]*?)\}/))==null?void 0:a[1])||"";for(const c of r.split(",")){const d=c.trim().split(/\s+as\s+/i),p=d[1]||d[0];/^[A-Za-z_$][\w$]*$/.test(p)&&s.push(p)}}return e=e.replace(o,`
