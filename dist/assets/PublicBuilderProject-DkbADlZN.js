import{ad as m,r as l,j as t,L as u}from"./vendor-CelcU6la.js";import{g as f}from"./apiClient-BkX2S1Q2.js";import"./index-B8eH0Hpz.js";function h(n){var a;let e=String(n||"");const s=[],o=/\bimport\s+(?:type\s+)?([\s\S]*?)\s+from\s+(['"])([^'"]+)\2\s*;?/g;for(const i of e.matchAll(o)){if(i[3]!=="lucide-react")continue;const r=((a=i[1].match(/\{([\s\S]*?)\}/))==null?void 0:a[1])||"";for(const c of r.split(",")){const d=c.trim().split(/\s+as\s+/i),p=d[1]||d[0];/^[A-Za-z_$][\w$]*$/.test(p)&&s.push(p)}}return e=e.replace(o,`
